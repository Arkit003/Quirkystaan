...
urlpatterns = [
    ...
    path('password_change/',
         auth_view.PasswordChangeView.as_view(template_name="users/password_change.html"),name="password_change"),
    path('password_change_done',
         auth_view.PasswordChangeDoneView.as_view(template_name="users/password_change_done.html"),name='password_change_done'),
    path("password_reset",
